...
def recommend(anime_name):
    matches = anime[anime['tittle'].str.lower() == anime_name.lower()]
    if matches.empty:
        return []
    ...
    for i in anime_list:
        ...
        recommended_name = anime.loc[recommended_index, 'tittle']
...
selected_anime = st.selectbox("", anime['tittle'].str.title().sort_values().unique())
